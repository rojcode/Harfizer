...
const germanPlugin_1 = require("../plugins/germanPlugin");
describe("CoreConverter with GermanLanguagePlugin", () => {
     ...
     */
    beforeEach(() => {
        const germanPlugin = new germanPlugin_1.GermanLanguagePlugin();
        converter = new core_1.CoreConverter(germanPlugin);
    });
    test("Convert positive number with decimal part (12345.67)", () => {
        ...
        expect(result).toBe("zwölf tausend dreihundertfünfundvierzig Komma sechs sieben");
    });
    test("Convert zero", () => {
    ...
    test('Process input with comma separators ("1,234,567.89")', () => {
        ...
        expect(result).toBe("eins Million zweihundertvierunddreißig tausend fünfhundertsiebenundsechzig Komma acht neun");
    });
    ...
    test('Process input with dash separators ("1-2343-53123")', () => {
        ...
        expect(result).toBe("eins Milliarde zweihundertvierunddreißig Million dreihundertdreiundfünfzig tausend einhundertdreiundzwanzig");
    });

...
const englishPlugin_1 = require("../plugins/englishPlugin");
describe("CoreConverter with EnglishLanguagePlugin", () => {
     ...
     */
    beforeEach(() => {
        const englishPlugin = new englishPlugin_1.EnglishLanguagePlugin();
        converter = new core_1.CoreConverter(englishPlugin);
    });
    test("Convert positive number with decimal part (12345.67)", () => {
        ...
        expect(result).toBe("twelve thousand three hundred forty-five point six seven");
    });
    test("Convert zero", () => {
    ...
    test('Process input with comma separators ("1,234,567.89")', () => {
        ...
        expect(result).toBe("one million two hundred thirty-four thousand five hundred sixty-seven point eight nine");
    });
    ...
    test('Process input with dash separators ("1-2343-53123")', () => {
        ...
        expect(result).toBe("one billion two hundred thirty-four million three hundred fifty-three thousand one hundred twenty-three");
    });

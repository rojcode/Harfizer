...
const persianPlugin_1 = require("../plugins/persianPlugin");
describe("CoreConverter with PersianLanguagePlugin", () => {
     ...
     */
    beforeEach(() => {
        const persianPlugin = new persianPlugin_1.PersianLanguagePlugin();
        converter = new core_1.CoreConverter(persianPlugin);
    });

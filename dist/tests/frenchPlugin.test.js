...
const frenchPlugin_1 = require("../plugins/frenchPlugin");
describe("CoreConverter with FrenchLanguagePlugin", () => {
     ...
     */
    beforeEach(() => {
        const frenchPlugin = new frenchPlugin_1.FrenchLanguagePlugin();
        converter = new core_1.CoreConverter(frenchPlugin);
    });
    test("Convert positive number with decimal part (12345.67)", () => {
        ...
        expect(result).toBe("douze mille trois cent quarante-cinq virgule six sept");
    });
    test("Convert zero", () => {
    ...
    test('Process input with comma separators ("1,234,567.89")', () => {
        ...
        expect(result).toBe("un - million - deux cent trente-quatre - mille - cinq cent soixante-sept - virgule - huit - neuf");
    });
    ...
    test('Process input with dash separators ("1-2343-53123")', () => {
        ...
        expect(result).toBe("un - milliard - deux cent trente-quatre - millions - trois cent cinquante-trois - mille - cent vingt-trois");
    });

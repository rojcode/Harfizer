...
exports.FrenchLanguagePlugin = void 0;
class FrenchLanguagePlugin {
    /**
    ...
    convertNumber(input, options) {
        ...
        const zeroWord = effectiveOptions.customZeroWord || FrenchLanguagePlugin.ZERO_WORD;
        const negativeWord = effectiveOptions.customNegativeWord || FrenchLanguagePlugin.NEGATIVE_WORD;
...
exports.FrenchLanguagePlugin = FrenchLanguagePlugin;
/**
 ...
 */
FrenchLanguagePlugin.ZERO_WORD = "zéro";
/**
 * Word used for negative numbers.
 */
FrenchLanguagePlugin.NEGATIVE_WORD = "moins";
/**

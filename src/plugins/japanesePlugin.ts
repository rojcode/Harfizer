...
export class JapaneseLanguagePlugin implements LanguagePlugin {
  /**
   ...
   */
  private static readonly NEGATIVE_WORD: string = "マイナス";
  ...
  public convertNumber(
    ...
    const zeroWord =
      effectiveOptions.customZeroWord || JapaneseLanguagePlugin.ZERO_WORD;
    const negativeWord =
